...
- 비회원의 경우 userName, userBirth, userEmail, userAuthPassword 값을 받는다.
...
|       | movieGrade           | INT          | 관람 등급 (0: 전체, 12: 12세 이상, 15: 15세 이상, １９: 청소년 불가) |                |
|       | movieDate            | DATE         | 개봉일                                               |                |
