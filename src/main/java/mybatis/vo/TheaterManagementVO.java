...
public class TheaterManagementVO {

    private String theaterRegion, theaterName, theaterStatus, screenName,
            screenSeatCount, screenType, screenStatus, theaterIdx, screenIdx;
