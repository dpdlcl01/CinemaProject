...
<head>
  ...
  <meta property="name"			id="metaTagTitle"	content="[메가박스]말할 수 없는 비밀"/>
  <meta property="description"	id="metaTagDtls"	content="“연주할 때만 느껴지는 감정이 있거든. 그게 널 만나면 느껴져”유학 중이던 피아니스트 유준은 팔목 치료를 위해 한국에 교환 학생으로 오게 된다.학교에 처음 간 그날, 신비로운 피아노 선율에 이끌려 도착한 연습실에서유준은 정아와 마주치고, 운명처럼 끌린 두 사람은 시간을 보내며 가까워진다.하지만, 연락처조차 알려주지 않는 정아와의 만남은 계속 엇갈리고,유준의 시선이 늘 자신을 향해 있다고 생각한인희의 갑작스러운 고백은 정아에게 큰 상처를 입힌다.그날 이후 사라진 정아의 행방을 찾던 유준은 정아의 비밀을 마주하게 되는데…“너와 나의 시간을 이어 준 연주곡 ‘시크릿’그렇게 마법 같은 사랑은 시작된 거야”"/>
  <meta property="keywords"		id="metaTagKeyword"	content="말할 수 없는 비밀,Secret: Untold Melody,판타지,도경수, 원진아, 신예은,"/>
  ...
  <meta property="og:url" 		id="fbUrl"		content="https://www.megabox.co.kr/movie-detail?rpstMovieNo=24130600" />
  <meta property="og:title" 		id="fbTitle"	content="[메가박스]말할 수 없는 비밀" />
  <meta property="og:description"	id="fbDtls"		content="“연주할 때만 느껴지는 감정이 있거든. 그게 널 만나면 느껴져”유학 중이던 피아니스트 유준은 팔목 치료를 위해 한국에 교환 학생으로 오게 된다.학교에 처음 간 그날, 신비로운 피아노 선율에 이끌려 도착한 연습실에서유준은 정아와 마주치고, 운명처럼 끌린 두 사람은 시간을 보내며 가까워진다.하지만, 연락처조차 알려주지 않는 정아와의 만남은 계속 엇갈리고,유준의 시선이 늘 자신을 향해 있다고 생각한인희의 갑작스러운 고백은 정아에게 큰 상처를 입힌다.그날 이후 사라진 정아의 행방을 찾던 유준은 정아의 비밀을 마주하게 되는데…“너와 나의 시간을 이어 준 연주곡 ‘시크릿’그렇게 마법 같은 사랑은 시작된 거야”"/>
  <meta property="og:image" 		id="fbImg"		content="https://img.megabox.co.kr/SharedImg/2025/01/06/veoYkRw8THPbrE9FobWUP1BVmEbMOXnp_316.jpg" />
  ...
  <script>
    ...
    var clientToken = 'pubc7d8e3738da148b50f6c3e151c758707';
    var applicationId = 'fa289ba6-d242-4d13-a2fa-e6c35019bf15';
    var service = 'megabox';
    var env = 'prod';
    if(activeProfile != 'prod'){
      clientToken = 'pubfad2407976bce7ca8e4d0802d2ea0425';
      applicationId = 'f3dcbf9e-83fe-49d2-a3f6-2d039078c6f5';
      service = 'megabox-stg';
      env = 'staging';
    }
    (function(h,o,u,n,d) {
...
// 		+$("input:checkbox[id='chkNonMbBokdPersonInfoProc']").is(":checked"));
                ...
                <div class="col left">
                  <div class="login-input-area">
                    ...
                    <div class="chk-util">
                      ...
                      <div class="right">
                        <div class="hp-ad">
                          <a href="https://www.sepay.org/spm/join?regSiteCode=XF&ctgCode=1&subCode=1" title="휴대폰 간편 로그인 선택" target="_blank" title="새창 열림"><span>휴대폰 간편로그인(유료서비스)<!--휴대폰 간편로그인--></span> <em>광고<!--광고--></em></a>
                        </div>
                      </div>
                    </div>
                    <!--// chk-util -->
  ...
  <div class="header-add-area">
    <div class="cont"><script data-id="U2ACFQVBQ0mneJSt6aNkaA" name="megabox_p/sub/sub@sub_top_1100x80?mlink=343" src="//cast.imp.joins.com/persona.js" async></script></div>
...
// 	//좌석수 param
  ...
  <script src="/js/megabox-simpleBokd.js"></script>
  <link rel="stylesheet" type="text/css" href="https://img.megabox.co.kr/js/style.css">
  ...
  <script type="text/javascript">
    $(function() {
      // 탭 버튼
      $(document).on('click', '.tab-list.fixed ul li a', function(e) {
        e.preventDefault();

        $(document).find('.tab-list.fixed ul li.on').removeClass('on');
        ...
        $.ajax({
          url: $(this).attr('href'),
          type: 'POST',
          data: JSON.stringify({rpstMovieNo: $(document).find('#rpstMovieNo').val()}),
          contentType: 'application/json;charset=UTF-8',
          success: function (d) {
            $('#contentData').html(d.toString());
      ...
      $('.splBtn').on('click', function(e) {
        ...
        else if(cd == 'mx') url = '/on/oh/ohc/BrchSpecial/dolbyatmosInfoPage.do'; // DOLBY ATMOS
      ...
      if('info' == 'one')
        url = '/on/oh/oha/Movie/selectMovieOneDetail.do';
      else if('info' == 'mp')
        url = '/on/oh/oha/Movie/selectMoviePostDetailC.do';
      else if('info' == 'st')
        url = '/on/oh/oha/Movie/selectMovieStilDetail.do';
      else
        url = '/on/oh/oha/Movie/selectMovieInfo.do';

      $.ajax({
        url: url,
        type: 'POST',
        data: JSON.stringify({rpstMovieNo: $('#rpstMovieNo').val()}),
        contentType: 'application/json;charset=UTF-8',
        success: function (d) {
          $('#contentData').html(d.toString());

          var parentIdx = $(document).find('.tab-list.fixed ul li.on').index();
    ...
    function setTab( idx ){
      switch( idx ) {
        default :
          url 	= location.protocol + "//" + document.domain + "/movie-detail?rpstMovieNo=24130600";
          metaFormat = {
            'scnTitle'			: "(말할 수 없는 비밀) 주요정보 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagTitle'	: "(말할 수 없는 비밀) 주요정보 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagDtls'		: $("#movieSynopCn").val()
            , 'metaTagKeyword'	: "말할 수 없는 비밀, , , "
            , 'metaTagUrl'		: url
          };
          $('#boxoInfoContent').show();
          break;
        case 1 :
          url 	= location.protocol + "//" + document.domain + "/movie-detail/comment?rpstMovieNo=24130600";
          metaFormat = {
            'scnTitle'			: "(말할 수 없는 비밀) 한줄평 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagTitle'	: "(말할 수 없는 비밀) 한줄평 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagDtls'		: "말할 수 없는 비밀 | 영화에 대해 이야기 나누어 보세요."
            , 'metaTagUrl'		: url
        ...
        case 3 :
          url 	= location.protocol + "//" + document.domain + "/movie-detail/trailer?rpstMovieNo=24130600";
          metaFormat = {
            'scnTitle'			: "(말할 수 없는 비밀) 예고편/스틸컷 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagTitle'	: "(말할 수 없는 비밀) 예고편/스틸컷 < 영화 | MEET PLAY SHARE, 메가박스"
            , 'metaTagDtls'		: "말할 수 없는 비밀 | 예고편/스틸컷으로 영화를 미리 확인해보세요."
            , 'metaTagUrl'		: url
  ...
  <input type="hidden" id="rpstMovieNo" value="24130600"/>
  <input type="hidden" id="movieSynopCn" value="&ldquo;연주할 때만 느껴지는 감정이 있거든. 그게 널 만나면 느껴져&rdquo;&lt;br&gt;&lt;br&gt;유학 중이던 피아니스트 유준은 팔목 치료를 위해 한국에 교환 학생으로 오게 된다.&lt;br&gt;학교에 처음 간 그날, 신비로운 피아노 선율에 이끌려 도착한 연습실에서&lt;br&gt;유준은 정아와 마주치고, 운명처럼 끌린 두 사람은 시간을 보내며 가까워진다.&lt;br&gt;&lt;br&gt;하지만, 연락처조차 알려주지 않는 정아와의 만남은 계속 엇갈리고,&lt;br&gt;유준의 시선이 늘 자신을 향해 있다고 생각한&lt;br&gt;인희의 갑작스러운 고백은 정아에게 큰 상처를 입힌다.&lt;br&gt;&lt;br&gt;그날 이후 사라진 정아의 행방을 찾던 유준은 정아의 비밀을 마주하게 되는데&hellip;&lt;br&gt;&lt;br&gt;&ldquo;너와 나의 시간을 이어 준 연주곡 &lsquo;시크릿&rsquo;&lt;br&gt;그렇게 마법 같은 사랑은 시작된 거야&rdquo;"/>
  ...
  <div id="schdlContainer" class="container area-ad no-padding-bottom">
    ...
    <div id="contents" class="no-padding">
      ...
      <input type="hidden" id="recordCountPerPage" name="recordCountPerPage" value="8"/>
      <input type="hidden" id="totalCnt" name="totalCnt" value="0"/>
      <input type="hidden" id="rpstMovieNo" name="rpstMovieNo" value="24130600"/>

      <!-- movie-detail -->
      <div class="movie-detail-page">
        <div class="bg-img" style="background-image:url('https://img.megabox.co.kr/SharedImg/2025/01/10/5icStMtQmSW7nxUfWzd7AbGr9cCxS49m_570.jpg');"></div>
        ...
        <div class="movie-detail-cont">
          ...
          <p class="d-day default">예매 D-15</p>
          ...
          <p class="title">말할 수 없는 비밀</p>
          <p class="title-eng">Secret: Untold Melody</p>
          ...
          <div class="btn-util">
            <button type="button" title="보고싶어 안함" class="btn btn-like" rpst-movie-no="24130600">
          ...
          <div class="reserve screen-type col-2">
            <div class="reserve">
              ...
              <a href="javascript:fn_bookingForm('24130600','basic');" class="btn reserve" title="영화 예매하기">예매</a>
              <a href="javascript:fn_bookingForm('24130600','DBC');" class="btn dolby">
      ...
      <div class="add-area infoContent" id="boxoInfoContent" style="display: none;">
