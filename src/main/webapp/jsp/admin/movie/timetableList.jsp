                    ...
                    <table>
                        ...
                        <c:forEach var="timetable" items="${timetableList}">
                            <tr>
                                ...
                                <td>${timetable.movieTitle}</td>
                                <td>${timetable.timetableStartTime}</td>
                                <td>${timetable.timetableEndTime}</td>
                                <td>${timetable.movieReservationRate}%</td>
                            </tr>
                        </c:forEach>
                        <c:if test="${fn:length(timetableList) == 0}">
                            <tr>
